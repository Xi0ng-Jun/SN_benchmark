...
from rag_eval.notebook_data import SUITES
...
def main():
    ...
    data = prepare(args.suite, args.raw, args.source, args.output, corpus_path=args.corpus, max_documents=args.max_documents)
